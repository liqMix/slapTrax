...
const (
	...
	RENDER_PLAY_DEFAULT = "render.play.default"

	// Settings
	//// System/Graphics
	SETTINGS_GFX_FULLSCREEN = "settings.gfx.fullscreen"
	SETTINGS_GFX_VSYNC      = "settings.gfx.vsync"
	SETTINGS_GFX_WIDTH      = "settings.gfx.width"
	SETTINGS_GFX_HEIGHT     = "settings.gfx.height"
	SETTINGS_GFX_RENDERW    = "settings.gfx.renderw"
	SETTINGS_GFX_RENDERH    = "settings.gfx.renderh"
	...
	SETTINGS_GAME_NOTESPEED   = "settings.game.notespeed"
